...
const AdvancedForm = ({ submitting, dispatch }) => {
  ...
  return (
    ...
    >
      <PageContainer content="修改申请信息">
        <Card title="审核信息" className={styles.card} bordered={false}>
          <Descriptions>
            <Descriptions.Item label="审核结果">失败</Descriptions.Item>
            <Descriptions.Item label="审核人">张科长</Descriptions.Item>
            <Descriptions.Item label="审核时间">2021-05-01</Descriptions.Item>
            <Descriptions.Item label="审核备注">申请中的人员信息安排不合理</Descriptions.Item>
          </Descriptions>
        </Card>
...
export default connect(({ loading }) => ({
  submitting: loading.effects['updateApplyForm/submitUpdateApplyForm'],
}))(AdvancedForm);
