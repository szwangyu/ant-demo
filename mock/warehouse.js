...
function post(req, res, u, b) {
  ...
  const { method, name, code, area, address, key } = body;
    ...
    case 'update':
      (() => {
        ...
        tableListDataSource = tableListDataSource.map((item) => {
          if (item.key === key) {
            newSupplier = { ...item, name, code, area, address };
            return { ...item, name, code, area, address };
          }
...
export default {
  'GET /api/stock/warehouse': get,
  'POST /api/stock/warehouse': post,
};
